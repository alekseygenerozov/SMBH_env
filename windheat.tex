...
\end{align}
 ...
 \begin{figure}
  ...
  \caption{\label{fig:NickPlot2} Effective wind velocities for
    ...
    formation histories of the form of
    equation~\eqref{sfrPerturbed}. In the top panel the star formation
    rate declines for a time, $\delta t_*=10^{7}$ years to
    fractions $\iota= 0.001$ (dashed), $\iota =0.1$ (dotted), and
    $\iota = 0.3$ (dot-dashed) of the halo averaged value. The bottom
    panel shows results for $\delta t_*=10^{8}$ years and
    $\iota$=0.001 (dashed) and 0.1 (dotted).}
  \end{figure}
