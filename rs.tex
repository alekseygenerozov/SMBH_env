...
\begin{align}
\rs=\frac{G \Mbh}{n \vw^{2}|_{\rs}}\left(\frac{9-\Gamma-2n}{2} \frac{\Mstar|_{\rs}}{\Mbh} +\frac{7}{2}-n\right),
\label{eq:rs2main}
\end{align}
...
%\x=\frac{\zeta^2 n \pm \sqrt{\zeta^4 n^2 - 4 \left(\frac{9}{2}-n\right)
%\left(\frac{7}{2}-n\right)}}{2 \left(\frac{9}{2}-n\right)}
\label{eq:rstag}
\end{align}
