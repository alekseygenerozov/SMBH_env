...
We have calculated steady-state models for the hot gaseous circumnuclear media of quiescent galaxies, under the assumption that gas is supplied exclusively by stellar wind mass loss and heated by shocked stellar winds, supernovae and black hole feedback.  We compute solutions for a range of different black hole masses, heating rates, and stellar density profiles.  Our numerical results (Table \ref{table:models}) are used to verify and calibrate analytic relationships (Appendix \ref{app:rs}, \ref{app:be}), which are in turn used to calculate the black hole accretion rate and how it varies with $\Mbh$ and the galaxy's star formation history.  Our results for $\dot{M}(\Mbh)$ are compared with observed trends of the nuclear X-ray luminosities of quiescent SMBHs and low luminosity AGN, as well as to address other key questions, such as the thermal stability of their accretion flows.  Our conclusions may be summarized as follows.

  \begin{enumerate}
  %Younger population=>higher accretion rate; generally higher eta and
  %lower vw except for very young stellar populations.
  \item The stagnation radius, $\rs$, divides the nuclear gas between an accretion flow and an
  ...
  \item The location of the stagnation radius and thus the accretion
    rate is very sensitive to the effective heating rate of the
    gas.  Stellar wind heating, supernovae, and AGN feedback depend on the black hole mass as well as the star
    formation history of the galaxy.  For example, for a galaxy with star formation within the last $\sim10^7$ years, both mass and energy injection are dominated by fast stellar winds from young stars ($w_w\simeq 1000$ km/s). In contrast, a galaxy with star formation relegated to the distant pass would have mass input dominated by old stars and heating dominated by AGN feedback and supernovae.  The energy input for galaxies with ongoing, continuous star formation is usually dominated by the youngest stars, while mass input is dominated by the old stellar poupation.  
