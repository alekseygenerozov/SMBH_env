...
\colhead{Ang.~Res.}  &
\colhead{$\nu$}          &
\colhead{F$_{\rm lim}^{(a)}$}               & 
\colhead{Area}          &
\colhead{$\Delta T$$^{(c)}$}            &
%\colhead{$T$$^{(d)}$}        &
\colhead{N$_{\rm obs}$$^{(e)}$}        &
\colhead{ref.}           
}
\startdata
\colhead{}           &
...
\colhead{}      \\
\hline
LOFAR & 80 & 0.15 & 11 & 1500 & 30 & 36 & 1\\
LOFAR-Expanded  & - & - & 1.1 & $10^{4}$  & 30  & 36 & -\\
VAST-Wide  & 10 & 1.3 & 0.5 & 10$^{4}$ & 1   & 1096 & 2\\
VAST-Deep & - & - & 0.05 & -  & 365  & 4 & - \\
VAST-Deep Single Field & - & - & - & -  & 1  & 365 & - \\
VLASS-Wide  & 2 & 3 & 0.1 & $10^{4}$ & 365  & 4 & - \\
VLASS-Deep  & 0.6 & - & 0.003 & 10  & 365  & 4 & - \\
%VLASS-Deep-Short  & - & - & 0.01 & 40  & 10  & 10 & - \\
%CMB50cm  & 840 & 150 & 3.2 & 10$^{4}$  & 1  & 1096 & - \\
%CMB2m  & - & - & 1.0 & -  & -  & - & - \\
CMB-fast  & 840 & 150 & 1.0 & 10$^{4}$  & 1  & 1096 & - \\
CMB-deep  & - & - & 0.1 & -  & 100  & 11 & - \\
\enddata
\tablecomments{Put Results Here}
\end{deluxetable}
