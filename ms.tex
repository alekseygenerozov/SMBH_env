...
\be
\rsoi \simeq G \Mbh/\sigma^2 \approx 14 M_{\bullet,8}^{0.6},
\label{eq:rsoi}
\ee
...
Radiative cooling is not included in the entropy equation, although its effect is assessed critically in $\S\ref{sec:cooling}$.  Across much of the parameter space radiative cooling is negligible compared to other sources of cooling (e.g., advection).  Radiative cooling cannot be neglected in some cases (if
