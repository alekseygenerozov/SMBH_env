...
\begin{align} v_{w}^{\rm C} \simeq
  \begin{cases} 160 \eta_{0.02}^{0.23}T_{\rm
C,9}^{0.12}\epsilon_{-2}^{0.23} M_{\bullet,8}^{0.18}\,{\rm km\,s^{-1}}
&, \text{core}\\ 90 \eta_{0.02}^{0.34}T_{\rm
C,9}^{0.17}\epsilon_{-2}^{0.34} M_{\bullet,8}^{0.17}\,{\rm km\,s^{-1}}
&, \text{cusp},
  \end{cases}
  \label{eq:vC2}
\end{align} 
...
\begin{align}
\frac{\dot{M}_{C}}{\dot{M}_{\rm edd}} \approx 
\begin{cases} 1.8\times 10^{-2} \eta_{0.02}^{0.12}T_{\rm
