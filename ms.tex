...
from large scales (galactic or extra-galactic), or whether significant growth results also from
internal, secular processes such as local stellar mass loss in the nuclear region.

Obtaining a better understanding of the mechanisms regulating accretion onto quiescent SMBHs would have implications
for a variety of observats, including constraints on the occupation fraction of SMBHs in
low mass galaxies, and the potential existence of intermediate mass
black holes.  \citet{Miller+15} use the average correlation
...
the detection threshold, a potentially worrisome assumption if different
