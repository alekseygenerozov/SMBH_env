...
\caption{\label{fig:bh_growth} Growth times $\Mdot/\MdotEdd$ in units
  ...
  equation~\eqref{eq:tgrow_min}. {\bf BDM: add Compton and Ia heating lines!}}
\end{figure}
