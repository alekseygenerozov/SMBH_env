...
We conclude by drawing attention to the following limitations of our model
    ...
    \item We adopt halo average star formation rates measured in
      ...
      \citep{PerezCidFernandes+:2013a}
      and so for a given halo mass
      ...
      younger stars towards the center of the galaxy. 

      In fact it is possible that the mass injection is in fact
      dominated by a nuclear star cluster with a break radius on
      parsec scales. Although this is much smaller than our fiducial
      break radius (100 pc). If the heating is sufficiently high
      moving the break radius inwards would merely change the outer
      gas density profile, without changing the stagnation radius in
      the flow and thus the accretion rate onto the black hole. Of
      course if one moves the break radius to where the stagnation
      radius would be the stagnation radius would move inwards
      somewhat. However note the for high heating rate ($v_w \gsim 500
      $ km/s and small black hole masses $\Mbh \lsim 10^7 \Msun$), we
      predict stagnation radii smaller than a parsec. 
