...
Thermal conduction, by contrast, results in only minor changes to our solutions for our fiducial value of the saturation parameter $\phi = 0.1$.  Conduction can, however, offset the effects of radiative cooling in making the flow more thermally stable (e.g.~\citealt{Zakamska&Narayan03}).  
