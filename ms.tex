...
In the opposite limit of weak heating ($v_{w} \ll \sigma_0$),
the stagnation radius moves towards the break radius, $\rb$ in the
stellar density profile, formally implying that almost entire ISM of the galaxy is
...
energy.
%   In fact, for core galaxies the specific
