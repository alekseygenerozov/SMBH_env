...
compared to the field population estimate above.  We conclude that
MSPs are unlikely to be an important source of heating, probably
insufficient to stabilize the steady flow against cooling instability
(e.g. $v_{\rm w,0}^{\rm MSP} < v_{\rm critt}$;
eq.~[\ref{eq:cooling2}])
