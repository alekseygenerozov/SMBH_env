...
\begin{tabular}{ll}
  ...
  velocity dispersion \\
  $\sigma_{\bullet}$ & The line of sight velocity dispersion from the  $\Mbh-\sigma$ relation (eq.~\eqref{eq:Msigma})\\
  $\sigma_0$ & stellar velocity dispersion (assumed to be radially
  constant and equal to $\sqrt{3} \Mbh$).\\
...
\caption{\label{fig:vwSources} {\it Top Panel:} Sources contributing
  ...
  impossible.  The latter quantity is calculated for core
  ($\Gamma=0.1$) galaxies  using mean scaling
