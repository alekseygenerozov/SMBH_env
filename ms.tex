...
relation. 
% \citep{ChaeBernardi+:2014a}
.  The second term, $v_{w}^{2}$, parameterizes additional sources of
...
(\citealt{ShcherbakovWong+:2014a}).  We define the ``Ia radius"
  ...
  equality we estimate $\sigma_0 \approx \sqrt{3}\sigma_{\bullet}$ using $M_{\bullet}-\sigma$ (eq.~[\ref{eq:Msigma}]).
