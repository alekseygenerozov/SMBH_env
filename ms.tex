...
\begin{equation}
\rinf \simeq G \Mbh/\sigma^2 \approx 14 M_{\bullet,8}^{0.6}\,{\rm pc},
\label{eq:rsoi}
\end{equation}
...
On the other hand, \citealt{LauerFaber+:2005a} find that $\sim
      ...
      It is thus possible that the mass injection to the nucleus could in some cases be dominated by a nuclear star cluster with its own break radius on parsec scales, i.e. much smaller than our fiducial value of $r_b \sim 100$ pc.  For a sufficiently high heating rate, a smaller break radius would not appreciably change the stagnation radius, resulting in a similar accretion rate onto the black hole.  On the other hand, a break radius smaller than the nominal stagnation radius would likely decrease the stagation radius and SMBH accretion rate.  
