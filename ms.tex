...
Finally, we note that \citealt{LauerFaber+:2005a} find that $\sim 60\%$ of cusp galaxies and $\sim29\%$ of core galaxies have (generally unresolved) emission in excess of the inward extrapolation of the Nuker law.  Indeed, some low mass galaxies with $\Mbh\lsim 10^{8} \Msun$ possess nuclear star clusters (\citealt{GrahamSpitler:2009a}), which are not accounted for by our simple parametrization of the stellar density.  In such cases gas and energy injection could be dominated by the cluster itself, i.e. concentrated within its own pc-scale ``break radius" which is much smaller than the outer break in the older stellar population on much larger scales.  Although our analysis does not take into account the influence such an inner break, for high heating rates the stagnation radius and concomitant accretion rate are not sensitive to the location of the break radius.
...
heating rate.  We emphasize that equation~\eqref{eq:eddr_analytic} represents the radial mass inflow rate on relatively large scales and does not include outflows from the accretion disk on small scales (e.g.~\citealt{Blandford&Begelman99}; \citealt{Li+13}), which could significantly reduce the fraction of $\dot{M}$ actually reaching the SMBH.
...
develops in this case greatly increases the gas density, resulting in local
thermal instability.
...
the SMBH by an energy $E_{\rm bind} \sim M_{\rm
  g}\sigma_0^{2}$.  From the above definitions we find that
 \be
