...
%10^{ -2 }$   & TI/convergence  \\
10$^{7}$ & 300 & 0.8 & 400 & $ 8.9 \times 10^{ -3 }$ & $ 4.7 \times
10^{ -2 }$ & Y &TI/convergence \\
10$^{6}$ & 1200 & 0.1 & U & $ 1.5 \times 10^{ -6 }$ & $ 4.1 \times
10^{ 4 }$ & N & \\
10$^{7}$ & 1200 & 0.1 & U & $ 9.5 \times 10^{ -6 }$ & $ 5.7 \times 10^{
  3 }$ & N & tried run w rb=100 pc resolved, what would happen if rb=400 pc?\\
10$^{6}$ & 1200 & 0.1 & 100 & $ 1.5 \times 10^{ -6 }$ & $ 4.1 \times 10^{ 4 }$ &N  &\\
10$^{7}$ & 1200& 0.1 & 100 & $ 9.5 \times 10^{ -6 }$ & $ 5.7 \times 10^{ 3 }$ &N&  \\
10$^{8}$ & 1200 & 0.1 & 100 & $ 6.0 \times 10^{ -5 }$ & $ 8.6 \times 10^{ 2 }$ & N& \\
10$^{8}$ & 1200 & 0.1 & 50 & $ 4.9 \times 10^{ -5 }$ & $ 1.2 \times 10^{ 3 }$ &N  &\\
10$^{8}$ & 1200 & 0.1 & 200 & $ 1.0 \times 10^{ -4 }$ & $ 3.4 \times 10^{ 2 }$ &N&  \\
%1 & 1200.0 & 0.1 & 300.0 & $ 1.9 \times 10^{ -4 }$ & $ 1.3 \times 10^{ 2 }$ &  convergence\\
10$^{8}$ & 1200 & 0.1 & 400 & $ 1.8 \times 10^{ -2 }$ & 0.37 & Y &TI/convergence\\
\hline
\label{table:models}  
\end{tabular}
