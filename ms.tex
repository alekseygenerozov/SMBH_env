...
reaches the SMBH. Thus we distinguish between the large scale inflow
rate, $\dot{M}$, and the accretion rate onto the black hole,
$\dot{M}_{\bullet}$.
...
most likely circularize within the inner sonic point of the flow
...
properties on large scales will generally be unaffected by angular
momentum.
...
where we implicitly the different sources of energy injection mix
efficiently. In reality, this may not be the case as slower velocity
sources cool and form high density structure due to external pressure
from faster winds \citep{Cuadra+2005}. 
