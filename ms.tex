...
$n$ (also evaluated at $r = \rs$); Note that $\vw^2=\vw0^2+\sigma^2$,
...
\begin{align}
  \x=\frac{1}{2 \zeta^2 n}\left[ \frac{\Mstar}{\Mbh}\left(A-n\right)+\left(B-n\right)\right],
...
\nonumber \\ &\sim
10.5 \left(\frac{\eta}{0.1}\right)^{-1}\left(\frac{r_{\rm s}}{r_{\rm
soi}}\right)^{-\beta} v_{500}^{9}\chi^{9} \nonumber \\ &\sim
4.53 \, 0.43^{\beta-1} \left(\frac{\eta}{0.1}\right)^{-1}
M_{\bullet,8}^{-1.2+0.4\beta} v_{500}^{9-2\beta}\chi^{9-2\beta}
\label{eq:condRatio1}
\end{align}
...
values of $v_{\rm w} \gtrsim 500$ km s$^{-1}$ and $\eta \gtrsim 0.1$,
but that it is safely neglected to first order for lower heating
rates. {\bf AG:Should probably include mass. Although this is tricky
  as cusp and core galaxies have opposite dependencies on mass.} 
...
&\approx&
  \begin{cases}
    ...
    \chi^{-3.8} v_{500}^{-3.8}  \eta_{0.02} \Msun \, \pyear& \text{core} \\
    5.3 \times 10^{-5} M_{\bullet,8}^{1.48} 
    \chi^{-2.4} v_{500}^{-2.4}  \eta_{0.02} \Msun \, \pyear  & \text{cusp}, 
  \end{cases}
...
\eddr&\approx&
  \begin{cases}
    ...
    \chi^{-3.8} v_{500}^{-3.8}  \eta_{0.02}   & \text{core} \\
    2.4 \times 10^{-5} \Mbheight^{0.48} 
    \chi^{-2.4} v_{500}^{-2.4}  \eta_{0.02}   & \text{cusp}, 
  \end{cases}
...
\begin{eqnarray}
  ...
  && \begin{cases}
    9.4 \times 10^{-19}M_{\bullet,8}^{-1.2}v_{500}^{2.2}\chi^{2.2}\,{\rm g\,cm^{-3}}
    & \text{core} \\
    1.1 \times 10^{-18} M_{\bullet,8}^{-1.5}v_{500}^{3.6}\chi^{3.6}
    \,{\rm g\,cm^{-3}}  & \text{cusp}, 
  \end{cases}
  \label{eq:rhostarrs}
\end{eqnarray}
...
\begin{eqnarray}
  ...
  \begin{cases}
    ...
    v_{500}^{3.8} \chi^{3.8}  \eta_{0.02}  & \text{core} \\
    140 \Mbheight^{-0.48}
    v_{500}^{2.4} \chi^{2.4}  \eta_{0.02}  & \text{cusp}, 
  \end{cases}
...
\left.\frac{q \vw^2/2}{\dot{q}_{\rm cool}}\right|_{\rm r{s}} \simeq
  \begin{cases}
   590 \eta_{0.02}^{-1} M_{\bullet,8}^{-0.76}v_{500}^{7.2}\chi^{7.2}  &, \text{core}\\
   210 \eta_{0.02}^{-1} M_{\bullet,8}^{-0.48}v_{500}^{5.8}\chi^{5.8}  &, \text{cusp},     
  \end{cases}
  \label{eq:cooling2}
\end{align}
...
\begin{align}
  ...
  \begin{cases}
    560 \Mbheight^{-0.76} \eta_{0.02}^{-1}(\chi v_{500})^{7.2}, & \text{core}\\
    310  \Mbheight^{-0.48} \eta_{0.02}^{-1}(\chi v_{500})^{5.8} ,   & \text{cusp}
  \end{cases}
  \label{eq:coolingratio}
\end{align}
We thus see that $t_{\rm cool} \lesssim 10 t_{\rm ff}$ at the
stagnation radius for low $v_{\rm w} \lesssim 250$ km s$^{-1}$ if
$\eta \sim 0.1$, but even for higher $v_{\rm w}$ if $\eta \sim 1$.
