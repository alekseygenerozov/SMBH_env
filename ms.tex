...
\frac{\dot{M}_{\rm max}}{\dot{M}_{\rm edd}} \simeq
  {\rm min}\begin{cases}
   4\times 10^{-4} \eta_{0.02}^{0.47} M_{\bullet,8}^{0.34}\,{\rm M_{\odot}\,yr^{-1}}  &, \text{core}\\
   2\times 10^{-4} \eta_{0.02}^{0.59} M_{\bullet,8}^{0.29}\,{\rm M_{\odot}\,yr^{-1}}    &, \text{cusp}\\
\eta M_{\bullet}/\dot{M}_{\rm edd}t_{\rm h} \approx 5.5\times 10^{-5}\eta_{0.02}\,{\rm M_{\odot}\,yr^{-1}} &, v_{\rm CL} < \sigma
  \end{cases}
  \label{eq:Mdotmax}
\end{align}
