...
\approx & 4.6\times 10^{15} {\rm ergs~s^{-1}~Hz^{-1}}
\left(\frac{\dot{M}}{10^{-5}M_\odot/{\rm year}} \right)^2
\left(\frac{\Mbh}{10^{6}~{\Msun}} \right)^{-1} \notag\\&\times
\left(\frac{h \nu}{0.5~{\rm keV}}\right)^{-3/2} v_{500}^2 \bar{Z}^2 \bar{g}_{\rm ff} Y_{\rm e} 
\end{align}
