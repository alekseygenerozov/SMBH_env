...
\be
\zeta\equiv \frac{\sqrt{v_w^2+\sigma_0^2}}{\sigma_0} < \zeta_c \approx \left(\frac{\rb}{\rsoi}\right)^{0.5(1-\Gamma)}.
\label{eq:zetacrit}
\ee
...
equation (\ref{eq:rsoi}) and the results of \citet{LauerFaber+:2007a}.
