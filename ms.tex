...
\author[Generozov, Stone, \& Metzger]{Aleksey Generozov$\thanks{E-mail: ag@astro.columbia.edu}$, Nicholas Stone, Brian~D.~Metzger\\
  Columbia Astrophysics Labratory, Columbia University, 550 West 120th
...
\citealt{Gallo+08}).  However, the physical processes involved in growing low mass blacks may be distinct from those operating at
higher SMBH masses and accretion rates in quasars.  A key open question is whether SMBHs grow primarily by accreting gas fed in directly
from galactic or extra-galactic scales, or whether significant growth results also from
internal, secular processes such as local stellar mass loss in the nuclear region.

A better understanding of what mechanisms regulate accretion onto quiescent SMBHs would have implications
for a variety of observations, such as constraints on the occupation fraction of SMBHs in
low mass galaxies.  \citet{Miller+15} use the average relationship between the nuclear X-ray luminosities, $L_{X}$, of a sample of elliptical galaxies and the black hole mass to infer tentative evidence for a SMBH
...
the detection threshold, a potentially problematic assumption if different
...
The gas density in galactic nuclei also influences the emission from stellar tidal
disruption events (TDEs), such as the high energy transient {\it
  Swift} J1644+57 (\citealt{Levan+11}; \citealt{Bloom+11},
\citealt{Burrows+11}; \citealt{Zauderer+11}).  This transient event was powered
by an impulsive relativistic jet, which produced synchrotron radio
...
modeling of J1644+57 showed that the CNM density was much lower than that measured surrounding Sgr A$^{\star}$
...
Variations in the properties of the CNM could help
...
\citet{Ho:2009a} estimates the SMBH accretion rates in a sample of
...
development of cooling instabilities on galactic scales, which temporarily increase the
gas accretion rate towards the nucleus until feedback becomes sufficiently effective to shut off the flow and halt SMBH growth.  Here we instead
...
\label{eq:Tanalytic}
\end{align}
where $v_{500} \equiv \tilde{v}_{w}/(500$ km s$^{-1}$) and $\densSlope \equiv -d{\rm ln}\rho/d{\rm ln\,r}|_{r_{\rm s}}$ is the
density power-law slope at $r = r_{\rm s}$ {\bf BDM: FIXXXX T equation!!}.  Empirically, we find that 
\begin{align}
...
\label{eq:rcirc}
\end{equation}
where we have used the definition $r_{\rm soi} \equiv GM_{\bullet}/\sigma^{2}$ and in the second inequality have assumed that $r_{\rm s} \lesssim r_{\rm soi}$, a condition which is satisfied for the thermally-stable solutions of interest.

\citet{EmsellemCappellari+:2007a} (their Fig.~2) find that $\lambda_R$ is generally $< 0.1$ on radial scales $<$ 10 per cent of the galaxy half-light radius and that $\lambda_R$ is with $R$ interior to this point.  From equation (\ref{eq:rcirc}) we thus conclude that $r_{\rm circ} \lesssim 0.01r_{s}$, i.e.~that gas will circularize well inside the inner sonic point of the flow (typically located at $\sim 0.1r_{\rm s}$; Fig.~\ref{fig:profiles}).  Angular momentum should only become dynamically important for thermally stable flows in a region that is causally disconnected from the outer part of the flow where the mass accretion rate is determined.
...
\begin{tabular}{lccccccccc}
  \hline
  {$M_{\bullet}$} & {$v_{w}$} & {$r_b^{(b)}$} &  $r_{\rm s}/r_{\rm soi}$ &  {$\left(\frac{\dot{M}}{\dot{M}_{\rm edd}}\frac{0.2}{\eta}\right)_{r_{s}}^{(c)}$} & {$\left(\frac{t_{\rm cool}}{t_{\rm ff}}\frac{0.2}{\eta}\right)_{r_s}^{(d)}$}  \\
  ($M_{\odot}$) & (km s$^{-1}$) & (pc) &- & - & - &  & \\ 
\hline
 & & & Cusp Galaxies, $\Gamma^{(a)} = 0.8$ & & & & & \\
 $    10^{ 6 }$ & 300 & 0.8 & 100 & $ 6.4 \times 10^{ -5 }$ & 17 \\
... & 600 & 0.8 & 100 & $ 1.1 \times 10^{ -5 }$ & $ 1.6 \times 10^{ 3 }$ \\
... & 1200 & 0.8 & 100 & $ 1.9 \times 10^{ -6 }$ & $ 7.2 \times 10^{ 4 }$ \\
$    10^{ 7 }$ & 300 & 0.8 & 25 & $ 3.9 \times 10^{ -4 }$ & 1.8 \\
... & ... & 0.8 & 50 & $ 3.9 \times 10^{ -4 }$ & $\mathbf{0.82}$ \\
... & ... & 0.8 & 100 & $ 5.2 \times 10^{ -4 }$ & $\mathbf{0.33}$ \\
... & ... & 0.8 & 200 & $ 5.9 \times 10^{ -4 }$ & $\mathbf{0.18}$ \\
... & ... & 0.8 & 400 & $ 1.8 \times 10^{ -3 }$ & $\mathbf{ 1.9 \times 10^{ -2 }}$ \\
... & 600 & 0.8 & 25 & $ 3.6 \times 10^{ -5 }$ & $ 4.4 \times 10^{ 2 }$ \\
... & ... & 0.8 & 100 & $ 3.6 \times 10^{ -5 }$ & $ 4.4 \times 10^{ 2 }$ \\
... & 1200 & 0.8 & 100 & $ 6.4 \times 10^{ -6 }$ & $ 2.4 \times 10^{ 4 }$ \\
$    10^{ 8 }$ & 300 & 0.8 & 25 & $ 9.4 \times 10^{ -4 }$ & $\mathbf{1}$ \\
... & ... & 0.8 & 50 & $ 1.6 \times 10^{ -3 }$ & $\mathbf{0.19}$ \\
... & ... & 0.8 & 100 & $ 3.3 \times 10^{ -3 }$ & $\mathbf{ 2.2 \times 10^{ -2 }}$ \\
... & ... & 0.8 & 200 & $ 7.2 \times 10^{ -3 }$ & $\mathbf{ 2.1 \times
  10^{ -3 }}$ \\
$    10^{ 8 }$ & 450 & 0.8 & 100 & $ 4.4 \times 10^{ -4 }$ & 4 \\
...$^{\dagger}$ & ... & 0.8 & 100 & $ 2.8 \times 10^{ -3 }$ & $\mathbf{2.8}$ \\
... & 600 & 0.8 & 25 & $ 1.3 \times 10^{ -4 }$ & $ 1.1 \times 10^{ 2
}$ \\
... & ... & 0.8 & 100 & $ 1.5 \times 10^{ -4 }$ & 76 \\
...$^{\dagger}$ & ... & 0.8 & 100 & $ 1.5 \times 10^{ -4 }$ & 70 \\
... & ... & 0.8 & 200 & $ 1.5 \times 10^{ -4 }$ & 67 \\
... & ... & 0.8 & 400 & $ 1.6 \times 10^{ -4 }$ & 58 \\
... & 1200 & 0.8 & 100 & $ 2.0 \times 10^{ -5 }$ & $ 7.2 \times 10^{ 3 }$ \\
  \hline
 & & & Core Galaxies, $\Gamma = 0.1$ & & & & & & \\
$    10^{ 6 }$ & 600 & 0.1 & 25 & $ 8.2 \times 10^{ -6 }$ & 99 \\
... & ... & 0.1 & 50 & $ 8.5 \times 10^{ -5 }$ & $\mathbf{0.45}$ \\
... & 1200 & 0.1 & 25 & $ 2.9 \times 10^{ -7 }$ & $ 1.4 \times 10^{ 5 }$ \\
... & ... & 0.1 & 50 & $ 2.9 \times 10^{ -7 }$ & $ 1.4 \times 10^{ 5 }$ \\
... & ... & 0.1 & 100 & $ 2.9 \times 10^{ -7 }$ & $ 1.4 \times 10^{ 5 }$ \\
$    10^{ 7 }$ & 600 & 0.1 & 25 & $ 4.3 \times 10^{ -5 }$ & 41 \\
... & ... & 0.1 & 50 & $ 2.3 \times 10^{ -4 }$ & $\mathbf{0.38}$ \\
... & 1200 & 0.1 & 25 & $ 1.8 \times 10^{ -6 }$ & $ 2.2 \times 10^{ 4 }$ \\
... & ... & 0.1 & 50 & $ 2.0 \times 10^{ -6 }$ & $ 1.7 \times 10^{ 4 }$ \\
... & ... & 0.1 & 100 & $ 2.5 \times 10^{ -6 }$ & $ 9.8 \times 10^{ 3 }$ \\
$    10^{ 8 }$ & 600 & 0.1 & 25 & $ 1.1 \times 10^{ -4 }$ & 31 \\
... & ... & 0.1 & 50 & $ 3.0 \times 10^{ -4 }$ & 3 \\
... & ... & 0.1 & 100 & $ 4.0 \times 10^{ -3 }$ & $\mathbf{ 5.7 \times 10^{ -3 }}$ \\
... & 1200 & 0.1 & 25 & $ 8.4 \times 10^{ -6 }$ & $ 5.6 \times 10^{ 3 }$ \\
... & ... & 0.1 & 50 & $ 9.8 \times 10^{ -6 }$ & $ 4.0 \times 10^{ 3 }$ \\
... & ... & 0.1 & 100 & $ 1.2 \times 10^{ -5 }$ & $ 2.4 \times 10^{ 3 }$ \\
... & ... & 0.1 & 200 & $ 2.1 \times 10^{ -5 }$ & $ 6.5 \times 10^{ 2 }$ \\
... & ... & 0.1 & 400 & $ 6.2 \times 10^{ -3 }$ & $\mathbf{ 5.8 \times 10^{ -3 }}$ \\
  \hline
...
0.2$.  $^{(d)}$Ratio of cooling timescale to free-fall timescale at
...
$\densSlope= 0.6$, respectively.  Our analytic estimates are found to
...
For low mass black holes, stellar heating is the most important on
...
with the persistently high mass loss rates of a relatively young
...
(Fig.~\ref{fig:eta}; top panel).  Star formation histories are also
...
Strikingly, {\it we find that galactic nuclei experiencing the same
  ...
  thermally stable flows across all black hole masses}.  {\bf NCS:
  deleted a sentence referring to old results on thermal instability -
  it is now correct to say we are thermally stable everywhere, yes? AG
  though note our kludgy way of including Ias if rs is inside of
  rIa. I also don't think it is fair to say that we obtain stability
  for large Mbh as the heating parameter would become comparable to
  the velocity dispersion.}

Realistic variations (``burstiness") in the star formation history
will often result in lower heating rates.  Figure \ref{NickPlot2}
...
{\bf NCS: is this reduced heating rate thermally unstable under
  Aleksey's revised formula?  We should comment. AG: What revised
  formula.}
...
in using scaling relationships ($\Mbh-\sigma$) and ($\Mbh-L_{\rm
  bulge}$) to measure $\Mbh$ as \citet{Miller+2015} do.
...
early type galaxies, assuming that gas is supplied entirely by stellar
wind mass loss and heated by shocked stellar winds, supernovae and
black hole feedback. We may use these profiles to calculate an $\Mdot$
onto each of sample galaxy's SMBH, and get the scaling of $\Mdot$ with
$\Mbh$. We may then compare our results with observed trends of
...
follows.
  ...
  \item We find that $\eddr \propto \Mbh^{\alpha}$ for
    $\Mbh\gsim4\times10^6$ and $\Mbh\lsim 2\times 10^8$, where the
    value of $\alpha$ with $\alpha\simeq$ for galaxies following the
    average star formation histories measured in cosmological
    simulations \citep{MosterNaab+:2013a}. This is in tension
    observations of nuclear X-ray luminosity which suggest that
    $\eddr$ increases towards smaller $\Mbh$
    \citep{Miller+15}. However, it is important to note that the
    inflow rate on large scale (which we calculate) may differ from
  ...
  \item We expect within scatter in nuclear x-ray luminosities at
    ...
    history from galay to galaxy (2) Variations in small scale outflow
    rates due to variations between galactic nuclear angular momenta.
  ...
  \item Low mass AGN have growth times comparable to the Hubble
    time. We have show that this would require accretion rates not
    consistent with steady state thermally stable accretion of stellar
    wind material.
