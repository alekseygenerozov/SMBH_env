...
%For instance, \citealt{Ciotti+10} find that between outbursts gas may exist in a
...
However, the hydrostatic nature of gas near the stagnation radius also renders the CNM at this location particularly susceptible to {\it local} thermal instabilities, the outcome of which could be distinct from the development of a cooling flow.       
