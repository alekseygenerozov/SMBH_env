...
break radius and for clarity we have not distinguished between cusp and core galaxies.  Equation (\ref{eq:conduction}) shows that even in the
...
In addition to our standard set of solutions neglecting thermal conduction and cooling, we explore a few test simulations including these effects, as marked in Table \ref{table:models}.  {\bf BDM: EXPAND!!!!  Explain that they don't matter.}
...
&, \text{cusp}.
  ...
  \label{eq:MdotC}
\end{align}
{\bf AG: Note that I have included the bolometric correction for now.  BDM: are you doing everything consistently?}
...
intermittency in the star formation history (~\ref{NickPlot2}) and
