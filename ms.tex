...
&\approx&
  \begin{cases}
    1.5 \times 10^{-4} M_{\bullet,8}^{1.76}
    \chi^{-3.8} v_{500}^{-3.8}  \eta_{-1} \Msun \, \pyear& \text{core} \\
    2.6 \times 10^{-4} M_{\bullet,8}^{1.48} 
    \chi^{-2.4} v_{500}^{-2.4}  \eta_{-1} \Msun \, \pyear  & \text{cusp}, 
  \end{cases}
...
\eddr&\approx&
  \begin{cases}
    6.6 \times 10^{-5} M_{\bullet,8}^{0.76}
    \chi^{-3.8} v_{500}^{-3.8}  \eta_{-1} \Msun \, \pyear& \text{core} \\
    1.2 \times 10^{-4} \Mbheight^{0.48} 
    \chi^{-2.4} v_{500}^{-2.4}  \eta_{-1} \Msun \, \pyear  & \text{cusp}, 
  \end{cases}
...
\left.\frac{q \vw^2/2}{\dot{q}_{\rm cool}}\right|_{\rm r{s}} \simeq
  \begin{cases}
   12\eta^{-1} M_{\bullet,8}^{-0.9}v_{500}^{7.2}\chi^{7.2}  &, \text{core}\\
   4\eta^{-1} M_{\bullet,8}^{-0.5}v_{500}^{5.8}\chi^{5.8}  &, \text{cusp},     
  \end{cases}
  \label{eq:cooling2}
\end{align}
...
\begin{align}
  ...
  \begin{cases}
    11 \Mbheight^{-0.8} \eta^{-1}(\chi v_{500})^{7.2}, & \text{core}\\
    6  \Mbheight^{-0.5} \eta^{-1}(\chi v_{500})^{5.8} ,   & \text{cusp}
  \end{cases}
