...
conclusions are summarized as follows.
  ...
  \item In the vicinity of the stagnation radius including the effects
    ...
    of heat from the very inner accretion flow can affect the flow on
    much larger scales \citep{Johnson+2007}. Angular momentum is also
    unlikely to invalidate our spherically symmetric model on large
    scales, given observationally inferred rotation rates of galactic
    nuclei near the stagnation radius ($\S\ref{sec:rotation}$).
