...
Between outbursts \citealt{Ciotti+10} find that galactic nuclei exist
in a quasi-stationary thermal stable state. We focus on this region of
parameter space calculating time-independent models, in which the
...
scales comparable to the sphere of influence.  We are thus motivated
to explore whether such steady flows are generally expected within the
nucleus, or whether in most galaxies the nuclear gas content is always
...
instability. {\bf AG this section still needs work...}
...
large scales and does not include small scale outflows. In reality, only
a fraction $\alpha$ (the standard Shakura-Sunyaev parameter--assumed
to be 0.1) will make it down to the black hole \citep{Li+2013}. 
