...
Many past studies have focused on relatively massive galaxies.  A key result of this work is the onset of , and the need for AGN feedback.  Here we instead neglect radiative cooling, focusing on time-dependent models.  This simple approach allows us to systematically and to derive simple analytic expressions that prove useful in exploring their sensitivity on.  
...
ultimately responsible for setting the SMBH accretion rate, although (when it exists)
