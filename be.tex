...
\caption{\label{fig:zetaCrit} {\emph Top panel:} Critical value
  ...
  equation~\eqref{eq:enthAnal}. {\emph Bottom Panel:} Minimum value of
  the stagnation radius for which $\mathcal{B} > 0$ at the break
  radius as a function of $\zeta /\zeta_{\rm c} < 1$ for $r_{\rm
    b}/r_{\rm inf}=10$.}
\end{figure}
